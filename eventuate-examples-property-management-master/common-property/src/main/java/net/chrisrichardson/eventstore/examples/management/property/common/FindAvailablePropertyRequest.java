...
public class FindAvailablePropertysRequest {
  ...
  public FindAvailablePropertysRequest() {
  }

  public FindAvailablePropertysRequest(String zipcode, int dayOfWeek, int hour, int minute) {
